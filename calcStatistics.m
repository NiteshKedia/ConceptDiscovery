function [ GT ] = calcStatistics( tripcomp_sub,tripcomp_verb,tripcomp_obj,unique_sub,unique_verb,unique_obj,unique_triplet_annotated,sub_similarity_verb_overlap,verb_similarity_subobj_overlap,obj_similarity_verb_overlap,pmi_subverb,pmi_verbobj)
...
%     end
%     GT{i,14} = average_pmi_sv/size(cartezianGT,1);
...
%     end
%     GT{i,15} = average_pmi_sv/size(cartezianGT,1);
...
%     
%     %Weighted Similarity
%     GT{i,13}= GT{i,4}*GT{i,10} + GT{i,5}*GT{i,11} + GT{i,6}*GT{i,12};
