...
tripcomp_current_sub = tripcomp_sub_3;
tripcomp_current_verb = tripcomp_verb_3;
tripcomp_current_obj = tripcomp_obj_3;
...
for iterations=4:8
            ...
            for k =1:length(final_candidate_set)
                ...
                if((length(final_sub_intersection)==0 || length(final_verb_intersection)==0 || length(final_obj_intersection)==0)||...
                    ...
                    [ tripcomp_next_sub,tripcomp_next_verb,tripcomp_next_obj,count ] = removeDuplicates( unique_sub,unique_verb,unique_obj,...
                        ...
                        final_sub_intersection,final_verb_intersection,final_obj_intersection,...
                        tripcomp_next_sub,tripcomp_next_verb,tripcomp_next_obj,pmi_subverb,pmi_verbobj,count);
                end
            end
        else
            [ tripcomp_next_sub,tripcomp_next_verb,tripcomp_next_obj,count ] = removeDuplicates( unique_sub,unique_verb,unique_obj,...
    ...
    eval(['GT_' num2str(iterations) ' = calcStatistics(tripcomp_next_sub,tripcomp_next_verb,tripcomp_next_obj,unique_sub,unique_verb,unique_obj,unique_triplet_annotated,sub_similarity_verb_overlap,verb_similarity_subobj_overlap,obj_similarity_verb_overlap);']);
